...
# Recordar el tamaño de la pantalla     ->    ANCHO, ALTO = 900, 500
    pygame.Rect(0, 0, 10, 460), # Inicia en (0,0) y de ahí sus dimensiones de rectángulo son de 10x460 según las dimensiones de la pantalla
    pygame.Rect(890, 0, 10, 460), # Basta con poner lo mismo del otro lado de la pantalla, por lo que su coordenada en X se desplaza a la orilla
]
